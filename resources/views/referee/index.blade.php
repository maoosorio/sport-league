        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('referees.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Referee</h3>
                        </div>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $referees->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
